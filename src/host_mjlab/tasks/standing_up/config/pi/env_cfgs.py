...
from host_mjlab.robots.pi_12dof import PI_ACTION_SCALE, get_pi_robot_cfg
from host_mjlab.tasks.standing_up import mdp
from host_mjlab.tasks.standing_up.standing_up_env_cfg import make_standing_up_env_cfg
...
def pi_standing_up_env_cfg(
  ...
  if "style_ground_parallel" in cfg.rewards:
    ...
    cfg.rewards["style_ground_parallel"].params["right_foot_body"] = (
      "r_ankle_pitch_link"
    )
  ...
  if "target_feet_height_var" in cfg.rewards:
    ...
    cfg.rewards["target_feet_height_var"].params["right_foot_body"] = (
      "r_ankle_pitch_link"
    )
